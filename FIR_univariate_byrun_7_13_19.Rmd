...
tstatdat = lapply(1:32,wbr.sliding.ttest.network,winval=0,region="lp",con1="intact",con2="scrambled", run="run1")
...
tstat.plot = ggplot(data = tstatdat,(aes(x =timepoint , y= tval,group =1)))  + geom_point(size = 3) +geom_line(size =2) + theme(text = element_text(size = 30, face = "bold"))  + ylab("t stat")  +
  geom_hline(aes(yintercept = 0)) + scale_y_continuous(limits= c(-4.5 , 4.5),breaks = c(-4,-3,-2,-1,0,1,2,3,4))
