...
```{r}
#tmap diffs first 
tmaprsa.diff.ps = tmaprsa %>% group_by(sub,condition,roi_group) %>% filter(roi == "rh-TPole", condition != "r_sameverb",condition != "scrambled") %>% summarise(simmean = mean(similarity))
...
betarsa.diff.ps = betarsa %>% group_by(sub,condition,roi_group) %>% filter(roi == "rh-TPole", condition != "r_sameverb",condition != "scrambled") %>% summarise(simmean = mean(similarity))
...
```{r}
#tmap diffs first 
tmaprsa.diff.ps = tmaprsa %>% group_by(sub,condition,roi_group) %>% filter(roi_group == "PM", roi =="rh-Prec", condition != "random",condition != "scrambled") %>% summarise(simmean = mean(similarity))
tmaprsa.diff.ps = tmaprsa.diff.ps %>%  spread(condition, simmean) 
tmaprsa.diff.ps = tmaprsa.diff.ps %>% mutate(psdiffs = intact - r_sameverb)
tmaprsa.diff.ps = data.frame(tmaprsa.diff.ps)

betarsa.diff.ps = betarsa %>% group_by(sub,condition,roi_group) %>% filter(roi_group == "PM", roi =="rh-Prec", condition != "random",condition != "scrambled") %>% summarise(simmean = mean(similarity))
betarsa.diff.ps = betarsa.diff.ps %>%  spread(condition, simmean) 
...
```{r}
#tmap diffs first 
tmaprsa.diff.ps = tmaprsa %>% group_by(sub,condition,roi_group) %>% filter(roi_group == "AT", roi == "rh-prc", condition != "random",condition != "scrambled") %>% summarise(simmean = mean(similarity))
tmaprsa.diff.ps = tmaprsa.diff.ps %>%  spread(condition, simmean) 
tmaprsa.diff.ps = tmaprsa.diff.ps %>% mutate(psdiffs = intact - r_sameverb)
tmaprsa.diff.ps = data.frame(tmaprsa.diff.ps)

betarsa.diff.ps = betarsa %>% group_by(sub,condition,roi_group) %>% filter(roi_group == "AT", roi == "rh-prc", condition != "random",condition != "scrambled") %>% summarise(simmean = mean(similarity))
betarsa.diff.ps = betarsa.diff.ps %>%  spread(condition, simmean) 
betarsa.diff.ps = betarsa.diff.ps %>% mutate(psdiffs = intact - r_sameverb)
betarsa.diff.ps = data.frame(betarsa.diff.ps)
