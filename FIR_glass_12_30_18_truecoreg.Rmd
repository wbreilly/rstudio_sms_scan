...
tstatdat = lapply(1:32,wbr.sliding.ttest.network,winval=2,region="AT",con1="intact",con2="scrambled")
...
list_of_dfs = NULL
list_of_dfs = parLapply(cl,1:32,make.sliding.df,winval=2,network="AT",con1="intact",con2="scrambled")
